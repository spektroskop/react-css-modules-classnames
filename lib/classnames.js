...
var wrap = (0, _ramda.curry)(function (styles, element) {
	...
	var transform = (0, _ramda.compose)((0, _ramda.when)((0, _ramda.always)(_reactUtil.isComponent), (0, _ramda.merge)({ styles: styles })), (0, _ramda.when)((0, _ramda.has)('className'), (0, _ramda.over)((0, _ramda.lensProp)('className'), (0, _ramda.compose)(styles, (0, _ramda.when)((0, _ramda.is)(String), (0, _ramda.split)(' '))))));
			...
			return function (_component) {
				...
				_createClass(_class, [{
					...
					value: function render() {
						return wrap(_bind2.default.bind(styles), _get(_class.prototype.__proto__ || Object.getPrototypeOf(_class.prototype), 'render', this).call(this));
					}
				}]);
